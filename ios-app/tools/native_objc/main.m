...
- (void)mountWebView {
    @try {
        ...
        NSString *adaptiveJs =
            ...
            "else document.documentElement.classList.remove('baowen-native-app');"
            /* 工天兜底：超时强制 site-bg-ready，避免 #1a0505 黑屏 */
            ...
            "r.classList.add('site-bg-ready','site-ui-ready');"
            ...
            "if(f&&typeof revealShellIframe==='function')revealShellIframe(f);"
            "}catch(eRv){}}"
            "setTimeout(function(){if(!document.documentElement.classList.contains('site-bg-ready'))__gtReveal();},500);"
            "setTimeout(__gtReveal,1800);}"
