...
- (void)mountWebView {
    @try {
        ...
        NSString *adaptiveJs =
            ...
            "+'html.gongtian-native-app:not(.auth-route) body,html.gongtian-native-app:not(.auth-route) body.page-fixed-bg-active,html.gongtian-native-app:not(.auth-route) body.bg-cover{' "
            ...
            "+'html.gongtian-native-app .settings-tab-nav{display:flex!important;flex-wrap:nowrap!important;overflow-x:auto!important;gap:.5rem!important;}'"
            "+'html.gongtian-native-app .settings-tab-nav .setting-tab,html.gongtian-native-app #syncServerTabBtn{' "
            "+'white-space:nowrap!important;flex:0 0 auto!important;width:auto!important;min-width:max-content!important;}'"
